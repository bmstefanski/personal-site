...
summary: A tutorial on how to create accessible and non-flickering dark mode with Next.js for both SSR and SSG.
date: '2021-09-11'
tags: ['Next.js', 'A11y']
draft: false
---
...
![Blinded by light mode meme](/static/images/creating-accessible-non-flickering-dark-mode-nextjs/blinded-by-light-mode.png)
...
The above solution can be applied to both - client and server side rendering. They will _in theory_, lower the [FCP](https://web.dev/fcp/) score, but it is rather a negligible decrease.
