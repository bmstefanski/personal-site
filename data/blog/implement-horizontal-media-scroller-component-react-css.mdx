...
summary: A copy-paste snippet for implementing a swipeable carousel or so called media scroller component. Built with almost no-JS.
date: '2022-05-16'
tags: ['Next.js', 'React']
draft: false
---
...
![A preview of media scroller component](/static/images/implement-horizontal-media-scroller-component-react-css/how-it-works.gif)
