...
summary: Learn how to install pip for Python on modern macOS and maintain compatibility with other tools.
date: '2023-03-27'
tags: ['Unix']
draft: false
---
...
```bash
$ python3 -m ensurepip && echo 'alias pip=pip3' >>~/.bash_profile && source ~/.bash_profile
```
