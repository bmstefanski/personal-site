...
summary: Discover how to fix a bug that occurs when importing JSON files in a component with the Linaria library, by making a simple adjustment to the configuration order.
date: '2023-03-26'
tags: ['React']
draft: false
---
...
![Linaria bug](/static/images/resolving-json-import-issue-linaria-library/screenshot.png)
