...
summary: How to prevent chroem from redirecting your local service from http to https
date: '2023-02-21'
...
![Google chrome net internals page](/static/images/prevent-chrome-from-redirecting-your-http-localhost-to-https/dns-purge.png)
