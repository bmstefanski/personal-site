...
summary: Discover a simple fix for the blank screen issue in OpenLens when working with kubectl by using a quick refresh command to reveal the clusters view.
date: '2023-03-22'
tags: ['DevOps']
draft: false
---
