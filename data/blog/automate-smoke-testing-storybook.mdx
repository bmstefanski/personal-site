...
summary: Discover how to use Storybook to automate smoke testing for your React components, eliminating the need for manual testing and streamlining your development process.
date: '2023-04-24'
tags: ['Testing', 'React']
draft: false
---
...
![Results of smoke testing using Storybook](/static/images/automate-smoke-testing-storybook/results.png)
